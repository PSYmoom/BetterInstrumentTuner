...
//This class exists to load up the violin tuner
public class violin_tuner extends MainActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        //Displays the required screen from layout file
        super.onCreate(savedInstanceState);
        setContentView(R.layout.violin_tuner);

        //Initializes the microphone for user input and text boxes for output on screen
        AudioDispatcher dispatcher = AudioDispatcherFactory.fromDefaultMicrophone(22050,1024,0);
        final TextView possibleHertz = findViewById(R.id.possibleHertzViolin);
        final TextView possibleString = findViewById(R.id.possibleStringViolin);
        final TextView suggestion = findViewById(R.id.suggestionViolin);
                ...
                if (inputHertz != -1) {
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            possibleString.setText("" + checkHertz(inputHertz, 'v'));
                            suggestion.setText("" + suggestion(checkHertz(inputHertz, 'v'), inputHertz, 'v'));
                        }
                    });
                }
            }
